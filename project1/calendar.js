...
//console.log(dates_arr.sort( () => .5 - Math.random() ))
dates_arr.sort();
...
for (let item of div_collection) {
  item.onclick = function () {
    ...
    window.location.href = "display.html#" + show_name + "&" + show_date;
  };
}

//var new_w = window.open("display.html");
//document.getElementById("parastasi").value = show_string;

//new_w.onload = function () {
//new_w.document.getElementById("parastasi").value = show_string;
//};

//console.log(
//item.getAttribute("data-date"),
//item.getAttribute("data-show_name")
//);
