const shows = {
  ...
  "mantama-batterflai": {
    ...
    production: "Εθνική Λυρική Σκηνή",
    img_src: "images/batterflai5.jpg",
...
var show_name = window.location.href.split("?")[1];
...
elem0 = document.querySelector(".media2");
elem0.style.backgroundImage = "url(" + shows[show_name]["img_src"] + ")";

var div0 = document.createElement("div");

div0.classList.add("title");
div0.innerHTML = shows[show_name]["name"];

elem0.append(div0);

/* SUNTHESI*/
elem7 = document.querySelector(".overview");
var div = document.createElement("div");
div.classList.add("role-name");
div.innerHTML = shows[show_name]["composer"];
div.innerHTML += "<span class='role'>" + "Σύνθεση" + "</span>";

/* LIBRETTO*/
elem7.append(div);

var elem = document.querySelector(".overview ");
console.log(typeof elem);

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.innerHTML = shows[show_name]["libretto"];
div1.innerHTML += "<span class='role'>" + "Λιμπρέτο" + "</span>";

elem.append(div1);

/* SUNTELESTES */
elem1 = document.querySelector(" .roles  ");
...
/* description*/
elem4 = document.querySelector(".overview");
var div5 = document.createElement("div");
div5.classList.add("important");
div5.innerHTML = shows[show_name]["production"];

elem4.append(div5);

/*hmeromhnies*/

elem3 = document.querySelector(".overview ");
console.log(typeof elem3);

keys = Object.keys(shows[show_name]["dates"]);

for (i in keys) {
  var div4 = document.createElement("div");
  div4.classList.add("dates");

  div4.innerHTML = shows[show_name]["dates"][keys[i]];

  elem3.append(div4);
}

/* sunopsh*/
elem2 = document.querySelector(".perigrafi");
var div3 = document.createElement("div");
div3.classList.add("synopsis");
div3.innerHTML = shows[show_name]["description"];

elem2.append(div3);

/* ACTORS */

dongiovanni_roles = document.querySelector(".dongiovanni_roles");

for (let [key, value] of Object.entries(shows[show_name]["roles"])) {
  var div = document.createElement("div");
  div.classList.add("dongiovanni_roles");
  div.innerHTML = key;
