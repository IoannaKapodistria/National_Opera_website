...
var title1 = document.querySelector(".giovanni > div.first");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.style.fontSize = "26px";
div1.innerHTML = shows["don-giovanni"]["name"];

title1.append(div1);

var composer = document.querySelector(".giovanni");
...
var libreto = document.querySelector(".giovanni");
...
var prod = document.querySelector(".giovanni");
...
var title2 = document.querySelector(".madam > div.first");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.style.fontSize = "25px";
div1.innerHTML = shows["mantama-batterflai"]["name"];

title2.append(div1);

var composer2 = document.querySelector(".madam");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.innerHTML = shows["mantama-batterflai"]["composer"];
div1.innerHTML += "<span class='role'>" + "Σύνθεση" + "</span>";

composer2.append(div1);

var libreto2 = document.querySelector(".madam");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.innerHTML = shows["mantama-batterflai"]["libretto"];
div1.innerHTML += "<span class='role'>" + "Λιμπρέτο" + "</span>";

libreto2.append(div1);

var prod2 = document.querySelector(".madam");

var div1 = document.createElement("div");
div1.classList.add("production");
div1.innerHTML = shows["mantama-batterflai"]["production"];

prod2.append(div1);

/* FIGARO */

var title3 = document.querySelector(".figaro > div.first");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.style.fontSize = "25px";
div1.innerHTML = shows["oi-gamoi-tou-figaro"]["name"];

title3.append(div1);

var composer3 = document.querySelector(".figaro");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.innerHTML = shows["oi-gamoi-tou-figaro"]["composer"];
div1.innerHTML += "<span class='role'>" + "Σύνθεση" + "</span>";

composer3.append(div1);

var libreto3 = document.querySelector(".figaro");

var div1 = document.createElement("div");
div1.classList.add("role-name");
div1.innerHTML = shows["oi-gamoi-tou-figaro"]["libretto"];
div1.innerHTML += "<span class='role'>" + "Λιμπρέτο" + "</span>";

libreto3.append(div1);

var prod3 = document.querySelector(".figaro");

var div1 = document.createElement("div");
div1.classList.add("production");
div1.innerHTML = shows["oi-gamoi-tou-figaro"]["production"];
...
main_div = document.querySelector(".main-frame");
...
for (i in dates_arr) {
  ...
  div.innerHTML = show_date + ":&nbsp&nbsp&nbsp&nbsp" + show_name;
  div.setAttribute("data-show_date", show_date);
  div.setAttribute("data-show_name", show_name);
  main_div.append(div);
}

div_collection = document.getElementsByClassName("event");
//console.log(div_collection);
for (let item of div_collection) {
  item.onclick = function () {
    let show_name = item.getAttribute("data-show_name");
    let show_date = item.getAttribute("data-show_date");
    window.location.href = "reservation.html#" + show_name + "&" + show_date;
  };
}
