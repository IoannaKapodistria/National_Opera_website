...
var plateia = document.getElementById("plateia");

plateia.addEventListener("click", function () {
  select = document.getElementById("row");
...
var exostis = document.getElementById("exostis");
exostis.addEventListener("click", function () {
  select = document.getElementById("row");
  while (select.length > 0) {
    select.remove(0);
  }
